...
class PostgresManager:
    ...
    def connect_with_url(self, url):
        while True:
            try:
                ...
                raise ValueError("Connection failed, retrying...", e)
                break
            else:
                break
            finally:
    ...
    def get_table_defintions_for_prompt_MOCK(self):
        pass

    # this function return a dictionnary that map table name in our database to table definitions
    def get_table_definitions_for_embeddings(self):
        table_names = self.get_all_table_names()
        definitions = {}
        for table_name in table_names:
