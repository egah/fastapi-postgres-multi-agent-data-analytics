...
import autogen
from . import llm
from .utils import Chat, ConversationResult
from src.agents_instrument import AgentInstruments
...
class Orchestrator:
    def __init__(
        ...
        self.name = name  # nom de l'orchestrateur
        self.agents = agents  # liste des agents
    ...
    def sequential_conversation(self, prompt: str) -> ConversationResult:
        ...
        # coversation sequentielle entre agent
        for idx, agent in enumerate(self.agents):
            ...
            # si le dernier message est un texte alors on fait un chat simple
            # un chat simple est :
            # agent a envoie un message a agent b
            # agent a enregistre le message comme chat dans la liste des chats
            # agent b repond a agent a
            #  le reponse de l'agent b est enregistrer dans la liste des messages
            # role de la liste des chats et de la liste des messages
